      ...
      <div class="food-content">
        <div class="image-header">
          ...
          <div class="back" @click="hide">
            <i class="sell-icon icon-arrow_lift"></i>
          </div>
        </div>
        <div class="content">
          ...
          <div class="cartcontrol-wrapper">
            <cartcontrol :food="food" @addCart="drop"></cartcontrol>
          </div>
        ...
        <div class="rating">
          ...
          <ratingselect :select-type="selectType" :only-content="onlyContent" :desc="desc" :ratings="food.ratings" @ratingType="setSelectTyped" @contentToggle="setOnlyContent"></ratingselect>
        </div>
